        ...
        for j, batch in enumerate(corpus_dataloader):
            ...
            try:
                ...
                # Patch heads by position
                    ...
                    np.save("results_head_decomp_mmarco/{}/{}_{}_head_by_pos.npy".format(perturb_type, qid, doc_id), detached_head_pos_results)
                    ...
                    for layer, head in attn_heads:
                        ...
                        if (i == 0 and j == 0) or (i == 10 and j == 10):
                            print(attn_pattern)
                        np.save("results_attn_pattern_mmarco/{}/{}_{}_{}_{}_attn_pattern.npy".format(perturb_type, qid, doc_id, layer, head), attn_pattern)
